...
namespace DAL
{
    public abstract class BaseRepository<T> where T : class
    {
        ...
        public virtual void Create(Entities db, T entity)
        {
            if (entity != null)
            {
                db.Set<T>().Add(entity);
        ...
        public virtual void Create(Entities db, IQueryable<T> entitys)
        {
        ...
        public virtual T Edit(Entities db, T entity, bool isAttach=true)
        {
            if(isAttach)
        ...
        /// <param name="db">实体数据</param>
        /// <param name="entitys">对象集合</param>
        public virtual void Edit(Entities db, IQueryable<T> entitys)
        {
